...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		sprDifficulty.animation.addByPrefix('easy', 'EASY', 24);
		sprDifficulty.animation.addByPrefix('normal', 'NORMAL', 24);
		sprDifficulty.animation.addByPrefix('hard', 'HARD', 24);
		sprDifficulty.animation.addByPrefix('rip', 'RIP', 24);
		sprDifficulty.animation.addByPrefix('perma', 'PERMA', 24); 
